...
public class Core {
    ...
    public static final String VERSION = "2.4.4.0", NATIVE_LIBRARY_NAME = "opencv_java244";
    public static final int VERSION_EPOCH = 2, VERSION_MAJOR = 4, VERSION_MINOR = 4, VERSION_REVISION = 0;
